    ...
    return (
        <footer className="py-16 md:py-32">
            <div className="mx-auto max-w-5xl px-6">
                ...
                <div className="my-8 flex flex-wrap justify-center gap-6 text-sm">
                    <Link
                        href="https://x.com/ArihantJain0101"
                        target="_blank"
                    ...
                    <Link
                        href="https://www.linkedin.com/in/arihant-bhansali2312/"
                        target="_blank"
                        rel="noopener noreferrer"
                        aria-label="LinkedIn"
                        className="text-muted-foreground hover:text-primary block">
                    ...
                    <Link
                        href="https://www.instagram.com/arihant_bhansaliofficial/"
                        target="_blank"
                        rel="noopener noreferrer"
                ...
                <span className="text-muted-foreground block text-center text-sm"> © {new Date().getFullYear()} Interview Prep, All rights reserved</span>
            </div>
        </footer>
    )
}
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 ">
        {/* Features Section */}
        <section id="start" className="w-full py-20 px-4 bg-gradient-to-r from-black to-gray-900">
        ...
        <section className="w-full py-16 px-4 bg-gradient-to-b from-black to-gray-900">
          <div className="max-w-7xl mx-auto space-y-40 ">
            ...
            <div className ="flex flex-col gap-6 ">
              <h2 id="your-interviews"  className="text-2xl font-bold text-white">Your Interviews</h2>
            ...
            <div className="flex flex-col gap-10 ">
              <h2 id="latest-hiring"  className="text-2xl font-bold text-white">Take an Interview</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
